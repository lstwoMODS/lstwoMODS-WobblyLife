...
{
    internal class SkyCustomizer : BaseHack
    {
        private static Color overrideSkyTint;
        private static bool bOverrideSkyColor;

        private static float overrideStarVisibility;
        private static bool bOverrideStarIntensity;
        ...
        public class Patches
        {
            ...
            public static bool LerpPrefix(ref DayNightCycle __instance, ref DayNightSetting from, ref DayNightSetting to, ref float progress)
            {
                ...
                Material material = (Material)r.GetField("skyBoxMaterial");
